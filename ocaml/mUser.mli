...
val get : [`View] IUser.id -> t option O.run
...
val block : [`Block] IUser.id -> blocked:Notification.t list -> unit O.run
...
module Backdoor : sig
  ...
  val obliterate : [`Admin] ICurrentUser.id -> IUser.t -> unit O.run
