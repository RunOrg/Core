...
let () = define UrlClient.Forums.def_delete begin fun parents entity access -> 
  ...
  let! submit = O.Box.react Fmt.Unit.fmt begin fun _ _ _ res -> 
    ...
    let url = Action.url UrlClient.Forums.home (access # instance # key) [] in
  ...
  O.Box.fill begin 
    ...
    Asset_Admin_Page.render (object
      ...
      method body = Asset_Forum_Delete.render (object
